...
// Import logos
import csulbLogo from '../assets/images/lblogo.svg';
      ...
      <div className="items-container">
        ...
        <VerticalTimeline>
          <VerticalTimelineElement
            ...
            icon={
              <div className="timeline-icon-wrapper">
                <img src={csulbLogo} alt="CSULB Logo" className="timeline-custom-icon" />
              </div>
            }
          >
            ...
            <p>Software Associate <br /> Full-stack Web Development</p>
          </VerticalTimelineElement>
          ...
          >
            <h3 className="vertical-timeline-element-title">California State University</h3>
            <h4 className="vertical-timeline-element-subtitle">Long Beach, CA</h4>
            <p>Research Associate <br /> Data Analysis, API Development, User Experience</p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <p>Application Development Analyst <br /> Telecom - API Development, User Experience</p>
          </VerticalTimelineElement>
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">Hyderabad, In</h4>
            <p>Programmer Analyst <br /> Insurance - API Development, User Experience</p>
          </VerticalTimelineElement>
